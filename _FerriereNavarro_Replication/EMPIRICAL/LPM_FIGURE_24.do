...
****************************************************************************************
#delimit ;
; local varreg lngdp_L*_P  lngdp_L*_R lngov_L*_P lngov_L*_R mtr_L*_P mtr_L*_R tb3_L*_P tb3_L*_R c_P c_R trend_*; //local control "controlbench"; 
#delimit cr
...
*--save
outsheet using "$outputdir${sep}LPM_FIGURE_24_`ids'_`fds'.csv", comma noquote replace
