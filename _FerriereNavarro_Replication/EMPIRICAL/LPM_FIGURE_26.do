...
if $case == 1{  // *--benchmark
	*------------------------------------------------------------------------------	
	...
	local varreg L(1/$LAG).lngdp  L(1/$LAG).lngov  L(1/$LAG).mtr  trend_*
	*------------------------------------------------------------------------------
}
	...
	*------------------------------------------------------------------------------	
	...
	local varreg L(1/$LAG).lngdp  L(1/$LAG).lngov  trend_*
	*------------------------------------------------------------------------------
}
...
*--save
outsheet using "$outputdir${sep}LPM_FIGURE_26_`cases'.csv", comma noquote replace
