module GLOBALS
    ...
    real(8), dimension(T_TR)   :: wgeH_TR, wgeHb_TR, Piw_TR, thetaw_TR, divw_TR, Avgetax
	...
	integer, parameter :: JxC = Nvar*T_TR/NC! 105  ! JxC = # of columns ran by each computer --> need NC*JxC = Nprm !!


    ! Save all cases
    integer :: index_decomp
