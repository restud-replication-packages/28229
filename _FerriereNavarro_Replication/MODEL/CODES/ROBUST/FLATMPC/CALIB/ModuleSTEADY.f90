...
contains
    ...
    adjparm = 1      ! =1 to adjust paramteres across iterations
    ...
    btaH = 0.99104825D0;  Dbta = 0.000575D0/dble(Nbeta-1);  ! errGE = -2
    btaH = 0.99204825D0;  Dbta = 0.000575D0/dble(Nbeta-1);  ! errGE = 0.7
    btaH = 0.99184825D0;  Dbta = 0.000575D0/dble(Nbeta-1);  ! errGE = 0.06
    btaH = 0.99183925D0;  Dbta = 0.000575D0/dble(Nbeta-1);  ! errGE = 0.02
    btaH = 0.99183025D0;  Dbta = 0.000575D0/dble(Nbeta-1);  ! errGE = 0.02

	
	do ib = 1, Nbeta
		bvec(ib) = btaH - dble(Nbeta-ib)*Dbta
	enddo
!	Pbeta = 1.0D0; Pbeta = Pbeta/sum(Pbeta);
!    Pbeta(1) = 0.70d0; Pbeta(2) = 1-Pbeta(1);
...
!
	do itb = 1, 1
        ...
        print *, '*********************************'
        print *, 'itb = ', itb, ', errGE = ', Aagg - (DB+Kagg)
        print *, 'blb = ', blb, ', bub = ', bub
        print *, 'Yagg = ', Yagg
        print *, 'EMP  = ', EMP
    ...
    maxitV = 500; wwV = 0.25D0; tolV = 1e-9; maxitH = 30
    showV  = 10
	...
	do itv = 1, maxitV
		...
		do ib = 1, Nbeta
            ...
            do is = 1, NS    
				...
				xr(is)	= min(amax,yl(is) + yk(is) + S(is,1) + TF - TAX(is))
				xl(is)  = amin
