module GLOBALS
    ...
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    integer, parameter :: T_TR = 160 !252 !250
	...
	!---Newton set-up
	integer, parameter :: Nvar = 4               ! number of variables to solve for: {r,w,lbd_t, div,q}
	...
	integer, parameter :: NC  = 1 ! 12  ! NC  = # of computers you're calling
	integer, parameter :: JxC = 120 !84  ! JxC = # of columns ran by each computer --> need NC*JxC = Nprm !!
