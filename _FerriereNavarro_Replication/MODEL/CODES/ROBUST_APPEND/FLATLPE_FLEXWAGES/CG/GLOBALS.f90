module GLOBALS
    ...
    !---preference shocks
	real(8), parameter :: rhow = 5.0D0*0.066D0      ! for hours
    ...
    ! Sticky wages
    real(8), parameter :: Piwbar = 1.0d0, phiwPi = 1.5d0, epswPi = 7.0d0, thetawPi = 0.0D0
    ...
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
	!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    integer, parameter :: T_TR = 252 !250
	...
	!---Newton set-up
	integer, parameter :: Nvar = 5               ! number of variables to solve for: {r,w,lbd_t, div,q}
    ...
    integer, parameter :: JxC = Nvar*T_TR/NC  ! JxC = # of columns ran by each computer --> need NC*JxC = Nprm !!

    !---capital good producer
    real(8), parameter :: qk0  = 1.00D0   ! steady-state price of capital
    ! real(8), parameter :: phiK = 130.10D0
    real(8), parameter :: phiK = 15.30D0
    ! real(8), parameter :: phiK = 130.30D0
    !  real(8), parameter :: phiK1 = 0.40D0
!    real(8), parameter :: phiK1 = 2.50D0
!    real(8), parameter :: IKrat = 0.020D0
!    real(8), parameter :: phiK0 = (1.0D0/(1.0D0-phiK1)) * (IKrat**phiK1)
!    real(8), parameter :: PHIx  = phiK0*(IKrat**(1.0D0-phiK1))
!    real(8), parameter :: phiK2 = dlta - PHIx

!    real(8) :: IKhat, PHIk, Pik, FCk, Iagg, Phi_TR(T_TR)
