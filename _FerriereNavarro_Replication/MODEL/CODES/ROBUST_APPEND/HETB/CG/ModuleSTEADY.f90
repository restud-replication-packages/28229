...
contains
    ...
    tolGE = 2e-5; maxitb   = 150; wwb  = 0.90D0
	...
	! blb  = 0.9990000D0; bub = 0.9990025D0
	...
	do itb = 1,  maxitb
		...
		!---update btaH bounds
		! if ( (abs(errGE) < tolGE) .and. (itb>=20)) then
    ...
    maxitV = 200; wwV = 0.25D0; tolV = 1e-9; maxitH = 40
    showV  = 10
